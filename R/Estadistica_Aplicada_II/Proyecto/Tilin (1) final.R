...
library(patchwork)
#Leer datos 
dataset<-read.csv("C:/Users/kraff/Desktop/Datos_Oscar2.csv", header = TRUE, sep = ',')
...
gqtest(fit)
gqtest(fit, alternative = "less")




performance::check_model(modelo_glm)
