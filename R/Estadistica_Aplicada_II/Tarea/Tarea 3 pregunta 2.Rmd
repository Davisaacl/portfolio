...
b0 <- -1
b1 <- 1
funct3b <- function(x){exp(b0)*x^{b1}}
plot(funct2b, from = 0, to = 2, ylim=c(-4,4), col = "blue")
par(new=TRUE)
...
b0 <- -1
b1 <- 1
funct4b <- function(x){exp(b0)*x^{b1}}
...
b0 <- -1
b1 <- 1
funct5b <- function(x){exp(b0)*x^{b1}}
...
b0 <- 1
b1 <- 2
funct5c <- function(x){exp(b0)*x^{b1}}
plot(funct5c, from = 0, to = 2, ylim=c(0,8), col = "green")
par(new=TRUE)

b0 <- -1
b1 <- 2
funct5d <- function(x){exp(b0)*x^{b1}}
...
plot(funct6a, from = 0, to = 2, ylim=c(0,2), col="red")
par(new=TRUE)
...
b0 <- -0.5
b1 <- 1
funct6b <- function(x){exp(b0)*x^{b1}}
