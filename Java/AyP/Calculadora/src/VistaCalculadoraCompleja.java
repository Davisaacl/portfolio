...
public class VistaCalculadoraCompleja extends JFrame{
	...
	protected JTextField textReal;
	protected JTextField textImaginaria;
	protected JTextField textReal2;
	protected JTextField textImaginaria2;
	protected JTextField textOperacion;
