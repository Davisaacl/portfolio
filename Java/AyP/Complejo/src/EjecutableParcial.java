...
public class EjecutableParcial {
	...
	public static void main(String[] args) {
		...
		//Suma
		System.out.println(CalculadoraCompleja.suma(x, u).toString());
		
		//Resta
		System.out.println(CalculadoraCompleja.resta(x, u).toString());
		
		//Multiplicación
		System.out.println(CalculadoraCompleja.multiplica(x, u).toString());
		
		//División
		System.out.println(CalculadoraCompleja.divide(x, u).toString());
